...
import { useLanguage } from '../../context/LanguageContext'; // make sure this exists
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (roleError || !roleData) {
        ...
        setLoading(false);
        Alert.alert('Unauthorized', 'Access denied. You do not have Manager privileges.');
        return;
      }
